...
const MOCK: Invoice[] = [
  ...
  { id: "INV-2024-002", reservationId: "RES-B10-1974", amount: "€2.80", status: "PENDING", createdAt: "Mar 24, 16:50" },
  { id: "INV-2024-003", reservationId: "RES-B10-0143", amount: "€5.60", status: "FAILED", createdAt: "Mar 23, 17:30" },
  { id: "INV-2024-004", reservationId: "RES-C05-8821", amount: "€3.20", status: "PAID", createdAt: "Mar 22, 09:15" },
];
